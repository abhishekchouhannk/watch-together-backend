...
// using ngrok for testing purposes, so we need to trust the proxy headers for the correct IP address
...
// Redirect equivalent shortcuts like /login, /register, /forgot-password to the auth page with the correct mode query param
app.get("/login", (req, res) => res.redirect("/auth?mode=login"));
app.get("/register", (req, res) => res.redirect("/auth?mode=register"));
app.get("/forgot-password", (req, res) =>
  res.redirect("/auth?mode=forgotPassword"),
);
